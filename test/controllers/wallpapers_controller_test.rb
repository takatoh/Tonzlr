...
class WallpapersControllerTest < ActionController::TestCase
  ...
  test "should create wallpaper" do
    assert_difference('Wallpaper.count') do
      post :create, wallpaper: { creator: @wallpaper.creator, sample_path: @wallpaper.sample_path, series: @wallpaper.series, source: @wallpaper.source, thumbnail_path: @wallpaper.thumbnail_path, title: @wallpaper.title }
    end
  ...
  test "should update wallpaper" do
    patch :update, id: @wallpaper, wallpaper: { creator: @wallpaper.creator, sample_path: @wallpaper.sample_path, series: @wallpaper.series, source: @wallpaper.source, thumbnail_path: @wallpaper.thumbnail_path, title: @wallpaper.title }
    assert_redirected_to wallpaper_path(assigns(:wallpaper))
  end
