...
class PoolsControllerTest < ActionController::TestCase
  ...
  test "should create pool" do
    assert_difference('Pool.count') do
      post :create, pool: { closed: @pool.closed, description: @pool.description, name: @pool.name, poolings_count: @pool.poolings_count }
    end
  ...
  test "should update pool" do
    patch :update, id: @pool, pool: { closed: @pool.closed, description: @pool.description, name: @pool.name, poolings_count: @pool.poolings_count }
    assert_redirected_to pool_path(assigns(:pool))
  end
